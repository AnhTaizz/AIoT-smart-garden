...
Ở thời điểm TASK-000A, các thư mục được đặt trong một thư mục kế hoạch lồng, cùng cấp với `docs/` hiện hữu. Sau đó project đã được chuyển an toàn lên root repository; không tạo lại tài liệu và template đã có.
...
## Sau TASK-000E — root migration và LOCAL MOBILE DEMO
